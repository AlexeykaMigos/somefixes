...
get_header(); 
$page = cinnamon_setting( 'pages.about', array() );
?>
...
<section class="cinnamon-section">
    <div class="cinnamon-container">
        ...
        <h1 class="cinnamon-title"><?php echo esc_html( $page['title'] ?? 'Cinnamon Desire' ); ?></h1>
...
<section class="about-section">
    <div class="about-container">
        <div class="about-image-wrapper">
            <img src="<?php echo esc_url( $page['image'] ?? 'https://scottishkittensnyc.com/wp-content/uploads/2026/01/k22.jpg' ); ?>" alt="<?php echo esc_attr( $page['title'] ?? 'Cinnamon Desire' ); ?>" class="about-photo">
        </div>
        <div class="about-content">
            <div class="about-badge">ОПЫТ ЗАВОДЧИКА</div>
            <h2 class="about-title">Более 10 лет профессионального пути</h2>
            <div class="about-text">
                <p><?php echo wp_kses_post( $page['body'] ?? 'Все началось с любви к одной кошке, которая переросла в дело всей жизни.' ); ?></p>
