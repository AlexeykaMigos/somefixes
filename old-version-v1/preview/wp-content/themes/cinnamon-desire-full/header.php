...
<header class="cd-site-header">
    <div class="header-inner">
        <div class="header-logo-block">
            <a href="<?php echo home_url(); ?>" style="text-decoration:none; display:flex; gap:10px; align-items:center;">
                ...
                <div class="logo-text-group">
                    <div class="logo-main"><?php echo esc_html( cinnamon_setting( 'brand.name', 'CINNAMON DESIRE' ) ); ?></div>
                    <div class="logo-sub"><?php echo esc_html( cinnamon_setting( 'brand.tagline', 'ПИТОМНИК ШОТЛАНДСКИХ КОШЕК' ) ); ?></div>
                </div>
            </a>
        </div>
        ...
        <nav class="header-nav">
            ...
            <a href="<?php echo site_url('/contacts'); ?>" class="nav-link">Контакты</a>
        </nav>
...
<div class="mobile-menu">
    ...
    <nav class="mobile-nav">
        ...
        <a href="<?php echo site_url('/faq'); ?>" class="nav-link">Вопросы</a>
        <a href="<?php echo site_url('/about-us'); ?>" class="nav-link">О нас</a>
        <a href="<?php echo site_url('/contacts'); ?>" class="mobile-contact-btn">Контакты</a>
